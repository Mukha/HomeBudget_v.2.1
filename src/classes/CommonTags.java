    ...
    public String getHeader(String type) {
        ...
        if (type.equals("login")) {
            ...
            return "<div class=\"row-fluid\">"
                    ...
                    + "</ul>"
                    + "<ul class=\"nav nav-sidebar\">"
                    + "<li><a href=\"statistics.jsp?type=ivse\">Annual statistics</a></li>"
                    + "<li><a href=\"statistics.jsp?type=month\">Monthly statistics</a></li>"
                    + "<li><a href=\"forecast.jsp?type=default\">Forecast</a></li>"
